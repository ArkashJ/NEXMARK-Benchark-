...
public class Query5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String kafkaSrcTopic = params.getRequired("src-topic");
...
//        env.enableCheckpointing(10000, CheckpointingMode.EXACTLY_ONCE);
        ...
        DataStream<String> stringMapper = windowed.map(new MapFunction<Tuple2<Long, Long>, String>() {
                    @Override
                    public String map(Tuple2<Long, Long> ins) throws Exception {
                        return ins.toString();
                    }
                })
                .name("stringMapper");//.slotSharingGroup("map");
